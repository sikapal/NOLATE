...
const UserNotif = () => {
  ...
  return (
    <>
      <div className=' mx-2 pb-4 bg-white rounded-2xl  pt-4 flex flex-col  shadow-xl  '>

        <h1 className="font-bold py-2 pl-4">Notifications</h1>
        <p className='text-gray-500  text-[14px] pl-4'>Choisissez le type de notifications concernant l'activité de cet utilisateur que vous désirez recevoir.</p>

        <div className='bg-[#EEEEEE] items-center justify-between  flex mx-1 my-3 px-2 py-2 font-bold text-[14px] text-[#727c8e] border-b-2 border-[#D9D9D9]'>
          <p className='w-1/3'>NOTIFICATION</p>
          <p className='w-1/3 text-center'>FREQUENCE</p>
          <p className='w-1/3 text-end'>ACTION</p>
        </div>
        <div className='bg-white items-center justify-between flex -my-1 px-2 mx-1  font-bold text-[14px] text-[#727c8e] border-b-2 border-[#D9D9D9]'>
