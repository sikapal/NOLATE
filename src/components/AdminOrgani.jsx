...
const AdminOrgani = () => {
    ...
    return (
        <>
            <div className='mx-2 bg-white rounded-xl  py-4 flex flex-col  shadow-xl  '>

                <h1 className="font-bold py-2 pl-4">Rôles et autorisations</h1>
                <p className='text-gray-500  text-sm pl-4'>Ce que vous pouvez faire en tantque administrateur</p>
